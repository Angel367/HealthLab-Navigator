...
function Main() {
    ...
    const calcMinMaxPrice = (analysisInLaboratories) => {
        if (analysisInLaboratories?.length === 0) {
                   ...
                   {branches.length > 0 ?
                       <>
                           ...
                           <div className="mt-3">
                                {page > 1 && (
                                  <>
                                    <button className="btn btn-primary mr-2" onClick={firstPage}>Первая</button>
                                    <button className="btn btn-primary mr-2" onClick={prevPage}>Назад</button>
                                  </>
                                )}
                                {page}
                                {page < Math.ceil(count / 10) ? (
                                  <>
                                    <button className="btn btn-primary mr-2" onClick={nextPage}>Вперед</button>
                                    <button className="btn btn-primary" onClick={lastPage}>Последняя</button>
                                  </>
                                ) : null}
                              </div>
                            </>
